...
async function getSSP(env, org, proc) {
  ...
  const url = `https://raw.githubusercontent.com/${env.DATA_OWNER}/${env.DATA_REPO}/main/tenants/${pOrg}/procedures/${id}/ssp.json`;
...
async function getRoPA(env, org) {
  ...
  const url = `https://raw.githubusercontent.com/${env.DATA_OWNER}/${env.DATA_REPO}/main/tenants/${pOrg}/ropa/ropa.json`;
  return fetchJson(url, { cf: { cacheTtl: 300, cacheEverything: true } });
}
...
// .wrangler/tmp/bundle-3ypxmG/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-3ypxmG/middleware-loader.entry.ts
